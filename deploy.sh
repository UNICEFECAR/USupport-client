...
then
    ...
    docker build -t client:$IMAGE_TAG .
    docker tag client:$IMAGE_TAG 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-client-api:$IMAGE_TAG

    # Push image to 
    docker push 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-client-api:$IMAGE_TAG
